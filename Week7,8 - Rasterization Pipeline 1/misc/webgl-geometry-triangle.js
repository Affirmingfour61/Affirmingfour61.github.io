...
class WebGLGeometryTriangle {
    ...
    render(camera, projectionMatrix, shaderProgram) {
        ...
        //  gl.vertexAttribPointer(x, y, z, 3, 0, 0);
    ...
    //    The camera has been positioned back away from the origin so 
    // the view matrix will reflect that and the projection 
    // is set to be perspective based on the parameters set earlier.  
    // Currently, only the worldMatrix is being sent. 
    //  Make sure that the view and perspective matrices are also set.
